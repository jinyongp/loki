...
reference:
	...
	LOKI_REFERENCE_PYTHON="$(abspath $(PYTHON_REFERENCE))" $(GO) test -count=1 -v ./internal/project ./internal/secret ./internal/process ./internal/action ./internal/skills ./internal/gitops ./internal/browser -run '^TestPython0471.*Differential$$'
