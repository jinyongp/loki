...
install -m 0755 "$SOURCE_DIR/scripts/loki-go-lifecycle.sh" "$ROOT/opt/loki/libexec/lifecycle"
...
install -m 0644 "$SOURCE_DIR/packaging/go/launcher.json.in" "$ROOT/usr/share/doc/loki/launcher.json.in"
install -m 0644 "$SOURCE_DIR/packaging/go/executor.json.in" "$ROOT/usr/share/doc/loki/executor.json.in"
...
install -m 0755 "$SOURCE_DIR/scripts/loki-go-lifecycle.sh" "$OUTPUT/install.sh"
