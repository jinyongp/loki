...
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/browser-proxy.service" "$ROOT/usr/lib/systemd/system/loki-go-browser-proxy.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/browser.service" "$ROOT/usr/lib/systemd/system/loki-go-browser.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/egress-proxy.service" "$ROOT/usr/lib/systemd/system/loki-go-egress-proxy.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/executor.service" "$ROOT/usr/lib/systemd/system/loki-go-executor.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/launcher.service" "$ROOT/usr/lib/systemd/system/loki-go-launcher.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/mcp.service" "$ROOT/usr/lib/systemd/system/loki-go-mcp.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/port-guard.service" "$ROOT/usr/lib/systemd/system/loki-go-port-guard.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/runtime.service" "$ROOT/usr/lib/systemd/system/loki-go-runtime.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/signing-agent.service" "$ROOT/usr/lib/systemd/system/loki-go-signing-agent.service"
install -m 0644 "$SOURCE_DIR/packaging/native/systemd/host.target" "$ROOT/usr/lib/systemd/system/loki-go.target"
install -m 0644 "$SOURCE_DIR/packaging/native/tmpfiles.d/runtime.conf" "$ROOT/usr/lib/tmpfiles.d/loki-go.conf"
