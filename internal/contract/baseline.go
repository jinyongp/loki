...
var currentToolNames = []string{
	...
	"secret_inspect", "secret_write", "secret_delete", "github_read", "github_write", "github", "github_issue_fields_read", "github_issue_fields_write",
