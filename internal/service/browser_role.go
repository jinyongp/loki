...
func BrowserOperations(driver BrowserCaller) map[string]rpc.Operation {
	...
	for _, operation := range []string{"start", "navigate", "state", "click", "hover", "drag", "wheel", "fill", "type", "key", "shortcut", "select_option", "set_checked", "focus", "upload", "dialog_state", "handle_dialog", "back", "forward", "reload", "stop_loading", "list_tabs", "switch_tab", "close_tab", "screenshot", "console", "network", "request", "websockets", "page_errors", "debug_diagnostics", "stop"} {
